...
makethisbetter feedback show fb_abc123 --md     # server-rendered markdown, cheapest tokens for agents
...
### `makethisbetter project show <id>`
...
```bash
makethisbetter project create "Acme" --domain acme.com
```
