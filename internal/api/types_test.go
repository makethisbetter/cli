...
func TestFeedbackJSONNullableFields(t *testing.T) {
	...
	if fb.ScreenshotURL == nil || *fb.ScreenshotURL != "https://cdn.example.com/screenshots/FB-1.jpg" {
		t.Errorf("ScreenshotURL: got %v, want the API screenshot URL", fb.ScreenshotURL)
	}
...
func TestFeedbackEvidenceFieldsSurviveRoundTrip(t *testing.T) {
	input := `{
		...
		"screenshot_url": "https://cdn.example.com/screenshots/FB-7.jpg",
		"screen_width": 1440,
		"screen_height": 900,
	...
	if fb.ScreenshotURL == nil || *fb.ScreenshotURL != "https://cdn.example.com/screenshots/FB-7.jpg" {
		t.Errorf("ScreenshotURL: got %v, want the API screenshot URL", fb.ScreenshotURL)
	}
	...
	for _, key := range []string{
		...
		"screenshot_url", "screen_width", "screen_height", "reporter_language",
	} {
		if _, ok := out[key]; !ok {
...
func TestFeedbackJSONFieldNames(t *testing.T) {
	screenshotURL := "https://cdn.example.com/screenshots/FB-1.jpg"
	fb := Feedback{
		ID:                 "FB-1",
		Reference:          "acme/FB-1",
	...
	expectedKeys := []string{
		...
		"ai_clarify_available", "screenshot_attached", "screenshot_url", "upvotes_count", "status", "priority",
	}
